...
class Load {
	...
	*/
	...
	/**
	* Requires the different parts of the template being used
	* @param {string} [name] The name of the templates containing folder
	* @param {array string/string} [templateProperties] Key/value pairs of 
	* 		The different files to use for the header, body, and footer:
	* 		'header' => Will look in 'headers' folder
	*		'body' => Will look in 'bodies' folder
	*		'footer' => Will look in 'footers' folder
	* @return void
	*/
